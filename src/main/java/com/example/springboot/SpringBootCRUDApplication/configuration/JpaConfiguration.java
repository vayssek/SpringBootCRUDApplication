package com.example.springboot.SpringBootCRUDApplication.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages="com.example.springboot.com.example.springboot.SpringBootCRUDApplication.repositories",
